    ...
    <>
      ...
      <div className='about-container'>
        ...
        <p className='info'>
          ...
          same generated terrains. Every aspect, from the gradient of the
          terrain, to the quanitity, size and variety of the trees, rocks and
          clouds is distinct.
        </p>
        <p className='info'>
          Our terrains are generated by computing the weighted sum of layers or
          "octaves" of simplex noise—each layer being transformed to a different
          scale— thereby capturing the subtleties of a genuine landscapes.
        </p>
        <p className='info'>
        ...
        <p className='info'>
          Notes: For now, please try not to press 'e' or 'shift' while holding
          any other key in the app, as this can lead to unexpected behavior. If
          there is no music playing, check if your browser is blocking
